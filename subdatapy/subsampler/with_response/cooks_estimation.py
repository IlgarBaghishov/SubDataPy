...
file_name_structures = "../../../../lanl_data/Be_large_subset_structures.h5"
file_name_energies = "../../../../lanl_data/Be_high_3.hdf"
...
# coeffs_low = np.load("../../../fidelity/Be/lowBe_reg/coefficients.npy")
coeffs_high = np.load("../../../fidelity/Be/highBe_reg/coefficients.npy")
y_high = aw @ coeffs_high
print(y_high.size == len(hlfpnt1))
del aw
bw_high = np.load("/vast/home/baghishov/old_entropy/qSNAP/big_files/npy_files/Be/bw_high.npy")[hlfpnt1]
# bw_low = np.load("/vast/home/baghishov/old_entropy/qSNAP/big_files/npy_files/Be/bw_low.npy")[hlfpnt1]
bw_diff = bw_high - y_high
...
df = pd.DataFrame(np.zeros((hlfpnt,3)),columns=['e_cooks','f_diag_rmse','f_diag_mae'])
...
for i,j in enumerate(ind_configs_index[:hlfpnt]):
    ...
    df.loc[i,'e_cooks'] = bw_diff[i_strt]**2 * diag_elms[i_strt]/(1-diag_elms[i_strt])**2
